...
> Этот README — мой личный путь программиста — что я сделал, через что прошёл и чему научился. Я веду его для себя, чтобы через год открыть и увидеть, насколько вырос.
