...
- [О себе](#о-себе)
- [Путь (Проекты)](#путь)
  - [1. Telegram Bot (Football)](#1-telegram-bot-football--с-этого-всё-началось)
  - [2. testCinema](#2-testcinema--онлайн-кинoплатформа-для-казахстанского-контента)
  - [3. ZhanFinance (JF-1C)](#3-zhanfinance-jf-1c--b2b-saas-crm-и-бухгалтерская-платформа)
  - [4. Air Canvas](#4-air-canvas--computer-vision-приложение-рисование-жестами)
  - [5. Envie](#5-envie--мой-цифровой-дом)
  - [6. Second Brain](#6-second-brain-личная-база-знаний-и-архитектурный-протокол-v20)
  - [7. MeDev (DevProfile)](#7-medev-devprofile--платформа-для-разработчиков-single-source-of-truth)
  - [8. Valeur (ATS & AI Hiring)](#8-valeur--платформа-умного-найма-и-мэтчинга)
  - [9. Mr Developer](#9-mr-developer--блог-5-недельный-курс-вайбкодинга-и-менторство)
  - [10. MrDevCourses](#10-mrdevcourses--educational-lms--vibe-coding-platform)
- [На горизонте: Склад](#на-горизонте-склад)
- [Инженерные и архитектурные качества](#инженерные-и-архитектурные-качества)
...
### 2. testCinema — онлайн-кинoплатформа для казахстанского контента

*Статус: дипломный проект, команда из 2 человек, разработка длилась 10 месяцев* · [Репозиторий](https://github.com/MrSgemaSeny/test_cinema) · *Стек: React, TypeScript (frontend), Python (FastAPI) + Spring Boot (backend), Docker, модульный монолит с внешними сервисами*
...
### 3. ZhanFinance (JF-1C) — B2B SaaS CRM и бухгалтерская платформа
...
### 4. Air Canvas — Computer Vision приложение (рисование жестами)
...
### 6. Second Brain (Личная База Знаний и Архитектурный Протокол v2.0)
...
### 7. MeDev (DevProfile) — Платформа для разработчиков (Single Source of Truth)
...
### 8. Valeur — платформа умного найма и мэтчинга
